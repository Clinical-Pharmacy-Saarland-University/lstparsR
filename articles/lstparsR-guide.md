# lstparsR: Tidy Parsing of NONMEM Listing Files
...
**lstparsR** provides a clean, validated interface for reading `.lst`
...
lstparsR automatically detects the estimation method from the `.lst`
...
For interactive exploration, lstparsR includes a Shiny application that
