---
title: "lstparsR: Tidy Parsing of NONMEM Listing Files"
output:
  rmarkdown::html_vignette:
    css: themakr-vignette.css
vignette: >
  %\VignetteIndexEntry{lstparsR: Tidy Parsing of NONMEM Listing Files}
...
| `fetch_ofv()` | Objective function value (with footer fallback) |
| `fetch_condn()` | Condition number from eigenvalues |
| `fetch_all()` | Run all parsers; return named list |
